...
local function moveToTarget(targetCFrame)
    ...
    local currentFarmDist = _G.SlowHub.DungeonFarmDistance or 4
...
local function farmLoop()
    ...
    if target then
        ...
        if enemyRoot then
            local currentHeight = _G.SlowHub.DungeonFarmHeight or 9
            local currentDist = _G.SlowHub.DungeonFarmDistance or 4
